...
class _ChatDetailPageState extends State<ChatDetailPage> {
  List<ChatMessage> messages = [
    ...
    ChatMessage(messageContent: "Hey, I am doing fine dude. What Bout You?", messageType: "sender"),
                ...
                child: Align(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      color: (messages[index].messageType  == "receiver"?Colors.grey.shade200:Colors.orange/*blue[200]*/),
                    ),
